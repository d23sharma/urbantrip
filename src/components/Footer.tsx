        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold">UrbanTrip</h3>
                <p className="text-xs text-white/70">Cabs</p>
              </div>
            </div>
            <p className="text-white/80 text-sm">
              Your trusted partner for comfortable and affordable cab services across India.
            </p>
          </div>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary transition-colors">
